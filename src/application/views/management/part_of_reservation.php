            ...
            <div class="card-body" >
              <div class="row">
                ...
                <?php if (!empty($visitor_data)) : ?>
                  <?php for ($value=0; $value < $booking_data['people_num']; $value++) :?>
                    <ul class="col-6" style="text-align: right;">参加者氏名<?php echo $visitor_data['number'];?>：</ul>
                    <ul class="col-6"><?php echo $visitor_data['name'];?></ul>
                  <?php endfor; ?>
                <?php endif; ?>
              </div><!-- /.row -->
            </div><!-- /.card-body -->
